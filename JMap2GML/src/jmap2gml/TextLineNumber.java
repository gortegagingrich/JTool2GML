...
public class TextLineNumber extends JPanel
   ...
   public void setDigitAlignment(float digitAlignment) {
      this.digitAlignment
              = digitAlignment > 1.0f ? 1.0f : digitAlignment < 0.0f ? -1.0f
                              : digitAlignment;
   }
   ...
   private void setPreferredWidth() {
      ...
      int digits = Math.
              max(String.valueOf(lines).length(), minimumDisplayDigits);
   ...
   private boolean isCurrentLine(int rowStartOffset) {
      ...
      if (root.getElementIndex(rowStartOffset) == root.getElementIndex(
              caretPosition)) {
         return true;
      } else {
         return false;
   ...
   private int getOffsetY(int rowStartOffset, FontMetrics fontMetrics)
      ...
      } else // We need to check all the attributes for font changes
      {
         ...
         for (int i = 0; i < line.getElementCount(); i++) {
            ...
            String fontFamily = (String) as.getAttribute(
