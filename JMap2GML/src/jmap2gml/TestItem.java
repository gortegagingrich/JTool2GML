...
class TestItem {
        ...
        public void draw(Graphics g) {
            switch (type) {
                ...
                case "objMiniBlock":
                    g.setColor(new Color(0xBBBBBB));
                    g.fillRect(x, y, (int)(16 * image_xscale - 1), (int)(16 * image_yscale - 1));
                    g.setColor(Color.BLACK);
                    g.drawRect(x, y, (int)(16 * image_xscale - 1), (int)(16 * image_yscale - 1));
                    g.setColor(new Color(0x111111));
                    g.drawLine(x, y, x + (int)(16 * image_xscale - 1), y + (int)(16 * image_yscale - 1));
                    g.drawLine(x, y + (int)(16 * image_yscale - 1), x + (int)(16 * image_xscale - 1), y);
                    break;
